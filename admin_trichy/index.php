            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="/admin_trichy">Admin-TRICHY</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row d-flex justify-content-center align-items-center h-100">
                <div class="col-12 col-md-8 col-lg-6 col-xl-5">
                    <div class="card" style="border-radius: 1rem;">
                        <form onsubmit="document.getElementById('loader').style.display='block'" action="/admin_trichy/login.php" method="POST" class="card-body p-4 text-center">
                            <h2 class="fw-bold mb-4 text-uppercase text-primary" style="font-weight:800">Admin-TRICHY Login</h2>
